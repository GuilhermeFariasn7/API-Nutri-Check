...
function CadEntyForm({ onCancel }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const requiredFields = [
                'razaoSocial', 'cnpjCpf', 'email', 'login', 'passwordEnty'
            ];
            ...
            const dadosParaEnviar = {
                ...
                uf: formData.uf,
                cep: formData.cep,
                ramoAtividade: formData.category,
                tipoEmpresa: formData.type,
                numeroFuncionarios: formData.numeroFuncionarios,
                numeroTurnos: formData.numeroTurnos,
                responsavelManipulacao: formData.responsavelManipulacao,
                cpfManipulador: formData.cpfManipulador,
                representanteLegal: formData.representanteLegal,
                cpfRepresentante: formData.cpfRepresentante,
                login: formData.login,
                senha: formData.passwordEnty,
                motivoInspecao: Array.isArray(formData.motivoInspecao)
                    ? formData.motivoInspecao.join(', ')
                    : formData.motivoInspecao
            };

            // Chama o serviço para cadastrar no backend
            const resultado = await entidadeService.cadastrarEntidade(dadosParaEnviar);
            ...
            alert(error.message || "Erro ao cadastrar entidade. Tente novamente.");
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <>
            <HeaderPadrao titulo="Cadastro de Entidade" />
                        ...
                        <form onSubmit={handleSubmit} className="entity-form">
                            ...
                            <div className="form-section">
                                ...
                                <div className="form-grid">
                                    ...
                                    {/* Senha */}
                                    <div className="form-group">
                                        <label htmlFor="passwordEnty">Senha da Entidade *</label>
                                        <input
                                            id="passwordEnty"
                                            type="passwordEnty"
                                            value={formData.passwordEnty}
                                            onChange={(e) => handleInputChange('passwordEnty', e.target.value)}
